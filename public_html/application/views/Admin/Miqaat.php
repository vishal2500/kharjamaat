...
<div class="container pt-5 margintopcontainer">
    <h1 class="text-center">Manage RSVP</h1>
        ...
        <div class="row">
            <div class="col-12 mbm">
                <div class="d-flex flex-row align-items-center">
                    ...
                    <div class="ml-auto">
                        <a href="<?php echo base_url('Admin/addmiqaat') ?>"><button type="button"
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-9">
                                        <h5 class="mt0"><a
                                                href="<?php echo base_url('Admin/modifymiqaat/') . $rv['id'] ?>"
                                                class="fontblack">
                                                <?php echo $rv['name'] ?>
                                            </a></h5>
                                    ...
                                    <div class="col-sm-12 col-md-3 rsvp-col">
                                        ...
                                        <div class="font-lvl-3 dinblock-xs">
                                            ...
                                            <a href="<?php echo base_url('Admin/modifymiqaat/') . $rv['id'] ?>"
