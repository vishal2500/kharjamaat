...
<div id="permissionDeniedCard" class="card popup-card" style="display: none;">
    <div class="card-body">
        <h5 class="card-title">Permission Denied</h5>
        <p class="card-text">You don't have permission to perform this action.</p>
...
<script>
    ...
    function handleAction() {
        document.getElementById('permissionDeniedCard').style.display = 'block';
    }
    function closePopup() {
    document.getElementById('permissionDeniedCard').style.display = 'none';
    }
