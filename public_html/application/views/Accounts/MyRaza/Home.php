...
<div class="margintopcontainer">
    <div class="container pt-5">
        <p class="h4 text-center mt-5" style="color:goldenrod; text-transform:uppercase">My Applications</p>
        <div class="container">
            <div class="row mt-5">
                <form class="form-inline my-2 my-lg-0 w-100">
                    ...
                    <!--<a class="form-control btn btn-success my-2 my-lg-0 ml-auto"-->
                    <!--    href="<?php echo base_url('/accounts/NewRaza'); ?>">New Request</a>-->
                </form>
            </div>
        </div>
                    ...
                    <thead>
                        ...
                        foreach ($raza as $r) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($r['coordinator-status'] == 0) { ?>
                                        <button type="button" class="btn btn-sm btn-primary remove-form-row" onclick="redirectto('accounts/edit_raza/<?php echo $r['id'] ?>');"><i class="fa fa-pen-to-square"></i></button>
                                        <button type="button" class="btn btn-sm btn-danger remove-form-row" onclick="redirecttodelete('accounts/DeleteRaza/<?php echo $r['id'] ?>');"><i class="fa fa-trash-alt"></i></button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
