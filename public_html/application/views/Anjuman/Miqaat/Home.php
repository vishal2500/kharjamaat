...
<div class="container margintopcontainer">
    <h1 class="text-center heading pt-5 mb-4">Miqaat</h1>
    <hr>
    <div class="continer d-flex justify-content-center">
        <div class="row container mt-5">
            <a class="col-6 col-md-3 col-xxl-2 py-2" href="<?php echo base_url('anjuman/managemiqaat') ?>">
            ...
            <a href="<?php echo base_url('anjuman/miqaatattendance') ?>" class="col-6 col-md-3 col-xxl-2 py-2 ">
                <div class="card text-center">
                    <div class="card-body">
